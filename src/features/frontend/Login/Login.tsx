...
const Login = () => {
  ...
  return (
    <>
      <div>
        <section className="bg-gray-1 py-2 dark:bg-dark">
          <div className="container mx-auto">
            <div className="-mx-4 flex flex-wrap">
              <div className="w-full px-4">
                <div className="relative mx-auto max-w-[525px] overflow-hidden rounded-lg bg-slate-300 px-10 py-5 text-center dark:bg-dark-2 sm:px-12 md:px-[60px]">

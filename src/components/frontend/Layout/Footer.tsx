        ...
        <footer className="bg-gray-50 dark:bg-gray-800 antialiased">
          <div className="p-4 py-6 mx-auto max-w-screen-xl md:p-8 lg:p-10">
            <div className="grid grid-cols-2 gap-8 md:grid-cols-3 lg:grid-cols-5">
              <div>
                <h2 className="mb-6 text-[16px] font-semibold text-gray-900 uppercase font-Inter dark:text-white">
                  Company
                </h2>
                <ul className="text-gray-500 dark:text-gray-400">
                  <li className="mb-3">
                    <a
                      href="#"
                      className="no-underline hover:underline text-[14px] text-black font-Outfit"
                    >
                      About
                    </a>
                  </li>
              ...
              <div>
                ...
                <ul className="text-gray-500 dark:text-gray-400">
                  <li className="mb-4">
                    <a
                      href="#"
                      className="no-underline text-[14px] text-black font-Outfit hover:underline"
                    >
                      Discord Server
                    </a>
                  </li>
            ...
            <div className="text-center">
              <a
                href="#"
                className="flex justify-center items-center mb-5 text-2xl font-semibold text-gray-900 dark:text-white font-Outfit no-underline"
              >
                <svg
                  className="mr-2 h-8"
                  viewBox="0 0 33 33"
              ...
              <span className="block text-sm text-center text-gray-500 dark:text-gray-400 font-Outfit">
                © 2021-2022{" "}
                <a
                  href="#"

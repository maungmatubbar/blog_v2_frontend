    ...
    <>
                ...
                routes?.map((route:any)=> (
                  <li key={route?.path}>
                    <NavLink
                      to={route?.path}
                      className={`
                      ${location.pathname===route?.path?'bg-gray-100 text-gray-900':'text-white'}
                      flex items-center
                       p-2 
                        rounded-lg dark:
                         hover:bg-gray-100
      ...
      <main>
        ...
        <div className="p-4 sm:ml-64">
          <div className="p-4 border-2 border-gray-200  rounded-lg dark:border-gray-700 drop-shadow-lg">
            <Outlet /> 
          </div>
        </div>
      </main>
